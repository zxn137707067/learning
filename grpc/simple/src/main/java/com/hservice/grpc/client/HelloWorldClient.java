...
import com.hservice.grpc.server.HelloWorldServer;
...
public class HelloWorldClient {
  ...
  public void greet(String name) {
   ...
   // new Gson().toJson(responseUpdate.getHelloReplyObject())
    //new Gson().toJson(responseUpdate)
  }
